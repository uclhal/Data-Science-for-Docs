...
4. Importing: Scripting your import (and file paths)
5. Importing: Using Google Sheets
...
R comes preloaded with different bits of data for you to explore. A famous data set describes characteristics of iris' (flowers).
...
The sheet is available [here](https://docs.google.com/spreadsheets/d/1FehptlE8kTJyEoVJW0WTcst_LmL7D19S9jOto8w8RRs/edit?usp=sharing).
...
- There are lots of different data structures in R, but we won't go through them all during this course.
